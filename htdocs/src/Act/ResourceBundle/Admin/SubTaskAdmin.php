 ...
 * @author ajansen
 */
class SubTaskAdmin extends Admin
{
    ...
    protected function configureDatagridFilters(DatagridMapper $datagridMapper)
    {
        $datagridMapper
            ...
            ->add("commontask.metatask", null, array('label' => $this->translator->trans("commontask.ParentMetatask")))
            ->add("commontask", null, array('label' => $this->translator->trans("subtask.ParentTask")))
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add("commontask.metatask", null, array('label' => $this->translator->trans("commontask.ParentMetatask")))
            ->add("commontask", null, array('label' => $this->translator->trans("subtask.ParentTask")))
            ->addIdentifier('name', null, array('label' => $this->translator->trans("name")))
            ->add('teams', null, array('label' => $this->translator->trans("teams")))
            ->add('_action', 'string', array('template' => 'ActResourceBundle:Admin:Tasks/BtnCustomSubTasks.html.twig'))
        ;
    }
}
